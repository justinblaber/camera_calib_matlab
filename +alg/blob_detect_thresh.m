function blobs = blob_detect_thresh(array, opts)
    ...
    %           axis
    %       .blob_detect_thresh_d_cluster - scalar; clusters blobs within d
    %           distance.
    %       .blob_detect_thresh_r1_cluster - scalar; clusters blobs within r1
    %           distance.
    %       .blob_detect_thresh_r2_cluster - scalar; clusters blobs within r2
    %           distance.
    %
    % Outputs:
