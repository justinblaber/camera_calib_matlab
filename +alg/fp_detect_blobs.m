function [p_fps, debug] = fp_detect_blobs(array, blobs, opts)
    % Obtains the locations of the four points (fiducial markers) around
    % the calibration board given initial blobs.
    %
    % Inputs:
    %   array - array; MxN array
    %   blobs - array; Px5 array containing initial guesses of ellipses
    %   opts - struct;
