function [p_fp_pss, debugs] = stereo_fp_detect_LoG(img_cbs, calib_config)
    ...
    [p_fp_pss.L, debugs.L] = alg.single_fp_detect_LoG(img_cbs.L, calib_config);

    % Do right images
    util.verbose_disp('------', 1, calib_config);
    util.verbose_disp('Performing four-point detection for right images...', 1, calib_config);
    [p_fp_pss.R, debugs.R] = alg.single_fp_detect_LoG(img_cbs.R, calib_config);
end
