function array = undistort_array(array_d, obj_distortion, A, d, undistort_array_interp)
    % Undistorts array.
    %
    % Inputs:
    ...
    p_p_ds = obj_distortion.p_p2p_p_d([x_ps(:) y_ps(:)], A, d);

    % Resample
    array = alg.interp_array(array_d, p_p_ds, undistort_array_interp);
