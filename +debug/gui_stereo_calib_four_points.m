    ...
    function plot_gui()  
        try        
            ...
            xlabel(axes_board_L,{['Path: ' calib.L.extrin(idx_board).cb_img.get_path()], ...
                                 ['Resolution: ' num2str(calib.L.extrin(idx_board).cb_img.get_width()) ' x ' num2str(calib.L.extrin(idx_board).cb_img.get_height())]}, ...
            ...
            xlabel(axes_board_R,{['Path: ' calib.R.extrin(idx_board).cb_img.get_path()], ...
                                 ['Resolution: ' num2str(calib.R.extrin(idx_board).cb_img.get_width()) ' x ' num2str(calib.R.extrin(idx_board).cb_img.get_height())]}, ...
                   'FontSize',8,'Interpreter','none');    
            drawnow
        catch e      
            if ishandle(f)
