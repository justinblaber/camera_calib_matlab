function sym_p_p_bar2p_p_d = heikkila97()
    ...
    %
    % Outputs:    
    %   sym_p_p_bar2p_p_d - symbolic function; describes mapping between 
    %       ideal pixel coordinates (with principle point subtracted) and 
    %       distorted pixel coordinates.
    
    % Declare symbolic function
    syms sym_p_p_bar2p_p_d(x_p_bar,y_p_bar,a,x_o,y_o,k1,k2,p1,p2)
    
    % Define symbolic function
    sym_p_p_bar2p_p_d(x_p_bar,y_p_bar,a,x_o,y_o,k1,k2,p1,p2) = ...
