...
% Debug
debug.plot_cb_config(cb_config,subplot(2,2,1:2,'parent',f1));
    ...
    case 'four_point_manual'
        ...
        for i = 1:length(cb_imgs.L)
            ...
            debug.plot_cb_refine_points(four_points_ps.L{i}, ...
                                        ...
                                        cb_config, ...
                                        false, ...
                                        subplot(2,2,2*i+1,'parent',f1));
            debug.plot_cb_refine_points(four_points_ps.R{i}, ...
                                        cb_imgs.R(i), ...
                                        alg.homography(four_points_w,four_points_ps.R{i},cb_config), ...
                                        cb_config, ...
                                        false, ...
                                        subplot(2,2,2*i+2,'parent',f1));
        end   
end
...
for i = 1:length(cb_imgs.L)
    ...
    debug.plot_cb_points_disp(board_points_ps.L{i}, ...
                              p_m.L, ...                              
                              cb_imgs.L(i), ...
                              subplot(2,2,2*i+1,'parent',f2));
                          
    debug.plot_cb_points_disp(board_points_ps.R{i}, ...
                              p_m.R, ...                              
                              cb_imgs.R(i), ...
                              subplot(2,2,2*i+2,'parent',f2));
end  
% Plot residuals
plot(res.L(:,1),res.L(:,2),'bo','parent',subplot(2,2,1,'parent',f2));
set(subplot(2,2,1,'parent',f2),'xlim',[-0.5 0.5],'ylim',[-0.5 0.5]);
daspect([1 1 1]);

plot(res.R(:,1),res.R(:,2),'bo','parent',subplot(2,2,2,'parent',f2));
set(subplot(2,2,2,'parent',f2),'xlim',[-0.5 0.5],'ylim',[-0.5 0.5]);
daspect([1 1 1]);
