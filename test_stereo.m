...
[rotations.L,translations.L,A.L,distortion.L,board_points_is.L] = alg.single_calibrate(cb_imgs.L, ...
                                                                                       four_points_is.L, ...
                                                                                       cb_config);
                                                                                  
[rotations.R,translations.R,A.R,distortion.R,board_points_is.R] = alg.single_calibrate(cb_imgs.R, ...
                                                                                       four_points_is.R, ...
                                                                                       cb_config);
...
for i = 1:length(cb_imgs.L)
    % Get residuals
    model_points_i.L = alg.apply_full_model(A.L,distortion.L,rotations.L{i},translations.L{i},alg.cb_points(cb_config));
    res.L = vertcat(res.L,model_points_i.L-board_points_is.L{i});   
    
    model_points_i.R = alg.apply_full_model(A.R,distortion.R,rotations.R{i},translations.R{i},alg.cb_points(cb_config));
    res.R = vertcat(res.R,model_points_i.R-board_points_is.R{i});   
...
for i = 1:length(cb_imgs.L)
    ...
    model_points_i.R = alg.apply_full_model(A.R,distortion.R,R_s*rotations.L{i},R_s*translations.L{i}+t_s,alg.cb_points(cb_config));
    res.R = vertcat(res.R,model_points_i.R-board_points_is.R{i});   
...
disp('--------------------------------------------');
[rotations,translations,A,distortion,R_s,t_s] = alg.refine_stereo_params(rotations, ...
                                                                         translations, ...
                                                                         A, ...
                                                                         distortion, ...
                                                                         R_s, ...
