...
switch cb_config.calibration
    ...
    case 'four_point_manual'
        ...
        four_points_is{1} = alg.refine_corners(four_points_is{1}, ...
                                               cb_imgs(1), ...
        ...
        four_points_is{2} = alg.refine_corners(four_points_is{2}, ...
                                               cb_imgs(2), ...
        ...
        four_points_is{3} = alg.refine_corners(four_points_is{3}, ...
                                               cb_imgs(3), ...
...
% Debug
for i = 1:length(cb_imgs)
    util.debug_refine_corners(board_points_is{i}, ...
                              cb_imgs(i), ...
                              alg.refine_window(four_points_is{i},cb_config), ...
