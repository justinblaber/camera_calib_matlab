...
[cb_imgs,board_points_ps,four_points_ps,A,distortion,rotations,translations,homographies_refine,cal_config] = util.read_single_calib('calibrations/single2.txt');
