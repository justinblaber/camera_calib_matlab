function test_dp_2_dp_1_p2p
    ...
    p_2s = alg.apply_homography_p2p(p_1s, H_12);
    delta = 1e-5;
    ...
    for i = 1:size(p_1s, 1)
        ...
        p_2_delta = alg.apply_homography_p2p(p_1_delta, H_12);
    ...
    % Assert
    assert(all(all(abs(dp_2_dp_1_finite - alg.dp_2_dp_1_p2p(p_1s, H_12)) < 1e-5)));
end
