function test_fp_detect_LoG
    ...
    % Set opts
    opts.blob_detect_r_range1 = 1;
    opts.blob_detect_r_range2 = 15;
    opts.blob_detect_step = 0.5;
    opts.blob_detect_num_cutoff = 1000;
    opts.blob_detect_LoG_cutoff = 0.1;
    opts.blob_detect_LoG_interp = 'cubic';
    opts.blob_detect_eccentricity_cutoff = 5;
    opts.blob_detect_lambda = 0.01;
    opts.blob_detect_maxima_it_cutoff = 10;
    opts.blob_detect_maxima_norm_cutoff = 1e-6;
    opts.blob_detect_centroid_it_cutoff = 10;
    opts.blob_detect_centroid_norm_cutoff = 0.1;
    opts.blob_detect_d_cluster = 2;
    opts.blob_detect_r1_cluster = 2;
    opts.blob_detect_r2_cluster = 2;
