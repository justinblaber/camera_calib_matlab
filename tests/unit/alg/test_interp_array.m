function test_interp_array
    ...
    % Assert
    assert(abs(alg.interp_array(array, [3 3], 'cubic') - array(3, 3)) < 1e-4)
    assert(abs(alg.interp_array(array, [2.5 2.5], 'cubic') - 0.273426562500000) < 1e-4)
end
